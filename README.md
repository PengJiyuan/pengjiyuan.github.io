...
| 文档 | 描述 |
|------|------|
| [什么是 AI？](./docs/01-what-is-ai.md) | AI 基本概念、发展历程 |
| [AI 能做什么？](./docs/02-what-ai-can-do.md) | AI 能力全景图 |
| [AI 术语大全](./docs/03-ai-terms.md) | 入门必知术语 |
...
| 文档 | 描述 |
|------|------|
| [什么是 Prompt？](./docs/08-what-is-prompt.md) | Prompt 基础概念 |
| [写好 Prompt](./docs/09-write-good-prompt.md) | Prompt 进阶技巧 |
| [Prompt 模板](./docs/10-prompt-templates.md) | 常用模板大全 |

### 第四阶段：AI 开发
| 文档 | 描述 |
|------|------|
| [什么是 API？](./docs/11-what-is-api.md) | API 基础概念 |
| [获取 API Key](./docs/12-get-api-key.md) | 各大厂商 API Key 申请 |
| [Python 调用 AI](./docs/13-call-ai-in-python.md) | Python 实战 |
| [做一个 AI 助手](./docs/14-build-ai-assistant.md) | 完整项目实战 |
